...
public class ProductoDAOImpl extends Database implements ProductoDAO{
    ...
    private final static String SQL_CREATE_PRODUCT = "INSERT INTO productos(nombre, pvp, gastos_envio, tiempo_preparacion) VALUES (?, ?, ?, ?)";
    ...
    public boolean addProducto(Producto producto) {
        try {
            ...
            pstm.setDouble(2, producto.getPrecioVenta());
            pstm.setDouble(3, producto.getGastosEnvio());
            pstm.setInt(4, producto.getTiempoPrep());
            pstm.executeUpdate();
            return true;
